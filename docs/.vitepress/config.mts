...
const siteSidebar = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "第 9 章：评估、观测与调试", link: "/chapters/chapter-09-evaluation-observability-debugging" },
      { text: "第 10 章：综合实战与公开部署", link: "/chapters/chapter-10-capstone-and-deployment" }
    ]
  },
  {
    text: "项目与示例",
  ...
  },
  {
    ...
    items: [
      ...
      { text: "LangGraph vs 普通链式调用", link: "/compare/langgraph-vs-linear-chains" }
    ]
  },
  {
    text: "帮助",
